  ...
  static const privacyPolicy = PolicyScreen(
    ...
    sections: [
      PolicySection(
        heading: null,
        body:
            'Like This! (이하 "앱")은 사용자의 개인정보를 중요하게 생각합니다. '
  ...
  static const termsOfService = PolicyScreen(
    ...
    sections: [
      PolicySection(
        heading: null,
        body:
            '본 이용약관은 Like This! 앱(이하 "서비스") 이용에 관한 조건을 규정합니다.\n\n'
            '최종 업데이트: 2026년 3월 14일',
      ),
      PolicySection(
        heading: '1. 서비스 이용',
        body:
            '본 서비스는 흑백 필름 카메라 앱으로, 사진 및 동영상 촬영과 편집 기능을 제공합니다. '
      ...
      PolicySection(
        ...
        body: '개발자는 사전 고지 없이 서비스의 일부 또는 전부를 변경하거나 중단할 수 있습니다.',
      ),
      PolicySection(
        heading: '6. 준거법',
